...
from lanraragi.utils import compute_upload_checksum, get_signature_hex, is_valid_signature_hex
from satellite.service.database import DatabaseService
from satellite.utils.file import flat_folder_to_zip
from satellite.utils.fdiscover import discover_all_archives_in_folder, discover_all_leaf_folders
...
async def upload_archives_from_folder(
    ...
    try:
        ...
        async with lock.writer_lock:
            ...
            if archive_is_dir:
                archives = discover_all_leaf_folders(upload_dir)
            else:
                archives = discover_all_archives_in_folder(upload_dir)
